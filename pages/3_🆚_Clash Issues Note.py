...
if screenshot_btn:
    ...
    img = st.image("https://via.placeholder.com/500x300", use_column_width=True, output_format="JPEG")
    screenshot_data = img.data

    # Generate a unique filename for the screenshot
    screenshot_name = datetime.datetime.now().strftime("%Y_%m_%d_%H_%M_%S") + ".jpg"

    # Save the screenshot to the image dictionary
    image_dict[screenshot_name] = screenshot_data
